 <!--=============================
        FOOTER START
    ==============================-->
    <footer class="logo-secondaryColor">
                    ...
                    <div class="col-xxl-4 col-lg-4 col-sm-9 col-md-7">
                        <div class="footer_content">
                            <a class="footer_logo" href="/">
                                <img src="{{ asset('assets/images/snazo_primary-logobg.jpg') }}" alt="snazo logo" class="img-fluid w-100 rounded-3">
                            </a>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="footer_bottom_text">
                            <p>Copyright ©<b> Snazo</b> 2025. All Rights Reserved</p>
                        </div>
                    </div>
                </div>
            </div>
